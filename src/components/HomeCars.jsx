  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.headerContainer}>
        ...
        <p className={styles.subtitle}>Discover premium vehicals with exceptional performance and  confort for your next journey</p>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className={styles.imageContainer} >
                <img src={car.image} alt={car.name} onError={handleImageError} className='w-full h-full object-cover transition-transform duration-500'
                  style={{
                    transform: hoveredCard === car.id ?
                      'rotate(0.5deg)' : 'scale(1) rotate(0)',
                  }}
                />
              ...
              <div className={styles.content} >
                ...
                <div className={styles.specsGrid}>
                  {[
                    ...
                    <button onClick={() => navigate(`/cars/${car.id}`, {state : {car}})} className={styles.bookButton}>
